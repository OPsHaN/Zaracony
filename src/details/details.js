...
const Details = () => {
  ...
  return (
    <>
      <header>
        <nav class="navbar navbar-expand-lg navbar-dark navbar-details ">
          <div class="container">
      ...
      <div class="desktop">
        <div class="container-fluid foot col-xl-12 col-lg-12 col-md-12 col-sm-12 d-xl-block d-lg-block d-md-block d-sm-none  mb-md-0">
          <div class="container ">
            <div class="row row-cols-auto pt-5">
              <div class="col-xl-12 col-lg-12 col-md-12 d-xl-block d-lg-block d-md-block d-sm-none mb-md-0">
                <title class="text-white d-flex align-items-center justify-content-right mb-5 mx-auto fs-1 " >
                  اسم باقة الشركة
                </title>
                <div class="howw">
                  <p class="text-right mb-5">الرئيسية/ اسم الشركة/اسم باقة الشركة</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <body>
        <div class="container ">
          <div class="row row-cols-auto mt-3 d-flex justify-content-center">
            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 mb-md-0 ">
              <div class="position-relative me-2">
                <div class="bord w-100">
                  <div class="card text-bg-light rounded-5 mb-3">
                    <div class="rounded-5 pic p-3">
                      <div class="text-white inn">
                        <img src="images/stclogo.png" class="img-fluid mt-3 ms-2" />
                        <h1 class=" ms-2">اسم باقة الشركة</h1>
                        <h2 class=" ms-2">يمكن للعملاء الاستفادة من الباقة من خلال إرسال 7651 كرسالة نصّية إلى 1100</h2>
                        <hr class="text-white-50 w-100 "></hr>
                        <div class="currencyy mt-4 ms-2">90 <span >ريال</span>
                          <p>+ ضريبة القيمة المضافة</p>
                        </div>
                        <button type="button" class="btn btn-light btn-lg w-100 ">اشترك الآن</button>
                        <div class="row mt-4">
                          <div class="col order-first ">
                            <div class="custom float-start">
                              <button type="button" class="btn btn-outline-light baqa"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-left-right " viewBox="0 0 16 16">
                                <path fill-rule="evenodd" d="M1 11.5a.5.5 0 0 0 .5.5h11.793l-3.147 3.146a.5.5 0 0 0 .708.708l4-4a.5.5 0 0 0 0-.708l-4-4a.5.5 0 0 0-.708.708L13.293 11H1.5a.5.5 0 0 0-.5.5zm14-7a.5.5 0 0 1-.5.5H2.707l3.147 3.146a.5.5 0 1 1-.708.708l-4-4a.5.5 0 0 1 0-.708l4-4a.5.5 0 1 1 .708.708L2.707 4H14.5a.5.5 0 0 1 .5.5z" />
                              </svg>مقارنة الباقة</button>
                            </div>
                          </div>
                          <div class="col order-last">
                            <div class="float-end ">
                              <button type="button" class="btn btn-outline-light baqa">بطاقة الباقة</button>
                            </div>
                          </div>
                        </div>
                      </div>
            ...
            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 mb-md-0">
              <div class="desktop">
                <div class="position-relative me-2">
                  <div class="bordd w-100">
                    <div class="card text-bg-light p-3 rounded-5 mb-3">
                      <div class="card-top ">
                        <h4>خصائص الباقة</h4>
                      </div>
                      <div class="card-body m-0 p-0">
                        <img src="images/Signal.png" class="img-fluid float-start me-3 mt-2" alt="Responsive image" />
                      ...
                      <div class="card-body m-0 p-0">
                        <img src="images/Phone_Rotate.png" class="img-fluid float-start me-3 mt-2" alt="Responsive image" />
                        <div class="detail float-start">
                      ...
                      <div class="card-body m-0 p-0">
                        <img src="images/Group 639.png" class="img-fluid float-start me-3 mt-2" alt="Responsive image" />
                        <div class="detail float-start">
                          <span >الصلاحية</span>
                          <p>90 يوم</p>
                        </div>
                      ...
                      <div class="card-body m-0 p-0">
                        <img src="images/Users.png" class="img-fluid float-start me-3 mt-2" alt="Responsive image" />
                        <div class="detail float-start">
            ...
            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-xs-12 mb-md-0">
              <div class="desktop">
                <div class="position-relative me-2">
                  <div class="bordd w-100">
                    <div class="card text-bg-light p-3 rounded-5 mb-3">
                      ...
                      <div class="card-body m-0 p-0">
                        <img src="images/chip card.png" class="img-fluid float-start me-3 mt-2" alt="Responsive image" />
                        <div class="detail float-start">
                          <span >نوع الخط</span>
                          <p>فاتورة</p>
                        </div>
                      ...
                      <div class="card-body m-0 p-0">
                        <img src="images/simcard.png" class="img-fluid float-start me-3 mt-2" alt="Responsive image" />
                        <div class="detail float-start">
                          <span >متوافق</span>
                          <p>شريحة</p>
                        </div>
                      ...
                      <div class="card-body m-0 p-0">
                        <img src="images/pin-1.png" class="img-fluid float-start me-3 mt-2" alt="Responsive image" />
                        <div class="detail float-start">
                          <span >المدن</span>
          ...
          <div class="container d-xl-none d-lg-none d-md-none d-block mx-auto">
            <h3 class="text-start mb-3 mt-3">التوافق</h3>
            <div class="row row-cols-auto">
              <div class="col-sm-6 mx-auto ">
                <div class="mbord ">
                  <div class="card text-bg-light p-3 text-center rounded-4 mb-3 ">
                    <div class="card-body m-0 p-0">
                      <img src="images/chip card.png" class="img-fluid mt-2" alt="Responsive image" />
                      <div class="detail ">
                        <span >نوع الخط</span>
                        <p>فاتورة</p>
                      </div>
              ...
              <div class="col-sm-6 mx-auto ">
                <div class="mbord ">
                  <div class="card text-bg-light p-3 text-center rounded-4 mb-3 ">
                    <div class="card-body m-0 p-0">
                      <img src="images/simcard.png" class="img-fluid  mt-2" alt="Responsive image" />
                      <div class="detail ">
                        <span >متوافق</span>
                        <p>شريحة</p>
                      </div>
            ...
            <div class="row row-cols-auto mb-3 mt-3">
              ...
              <div class="col-sm-6 mx-auto ">
                <div class="mbord ">
                  <div class="card text-bg-light p-3 text-center rounded-4 mb-3 ">
                    <div class="card-body m-0 p-0">
                      <img src="images/pin-1.png" class="img-fluid  mt-2" alt="Responsive image" />
                      <div class="detail ">
                        <span >المدن</span>
                        <p>الرياض، جدة، الدمام</p>
                      </div>
            ...
            <h3 class="text-start mb-3">خصائص الباقة</h3>
            <div class="row row-cols-auto">
              <div class="col-sm-6 mx-auto ">
                <div class="mbord ">
                  <div class="card text-bg-light p-3 text-center rounded-4 mb-3 ">
                    <div class="card-body m-0 p-0">
                      <img src="images/Signal.png" class="img-fluid mt-2" alt="Responsive image" />
                      <div class="detail ">
                        <span >البيانات</span>
                        <p>20 جيجابايت</p>
                      </div>
              ...
              <div class="col-sm-6 mx-auto ">
                <div class="mbord ">
                  <div class="card text-bg-light p-3 text-center rounded-4 mb-3 ">
                    <div class="card-body m-0 p-0">
                      <img src="images/Phone_Rotate.png" class="img-fluid mt-2" alt="Responsive image" />
                      <div class="detail ">
                        <span >دقائق محلية</span>
                        <p>لا محدودة</p>
                      </div>
            ...
            <div class="row row-cols-auto mt-3">
              <div class="col-sm-6 mx-auto ">
                <div class="mbord ">
                  <div class="card text-bg-light p-3 text-center rounded-4 mb-3 ">
                    <div class="card-body m-0 p-0">
                      <img src="images/Group 639.png" class="img-fluid mt-2" alt="Responsive image" />
                      <div class="detail">
                        <span >الصلاحية</span>
                        <p>90 يوم</p>
                      </div>
              ...
              <div class="col-sm-6 mx-auto ">
                <div class="mbord ">
                  <div class="card text-bg-light p-3 text-center rounded-4 mb-3 ">
                    <div class="card-body m-0 p-0">
                      <img src="images/Users.png" class="img-fluid mt-2 " alt="Responsive image" />
                      <div class="detail">
                        <span >تواصل اجتماعي</span>
                        <p>لا محدودة</p>
                      </div>
          ...
          <div class="row row-cols-auto pt-5">
            <div class="col-xl-4 col-lg-6 col-md-12 col-sm-12 mb-md-0">
            </div>
            <div class="col-xl-8 col-lg-6 col-md-12 col-sm-12 mb-md-0">
              <h4>ملاحظات</h4>
              <div class="how mb-5">
                <p class="text-right">
        ...
        <div class="container baqat pb-5 mb-5">
          <div class="row">
            <div class="col order-first">
              <div class="custom float-start">
                <h1 class="my-element decorative-linee ">باقات مشابهة</h1>
              </div>
            </div>
          </div>
          <div class="row ">
            ...
            <div class="col-xl-4 col-lg-6 col-md-12 col-sm-12 mb-5 d-flex align-items-center justify-content-center ">
              <div class="position-relative me-5 mb-3">
      ...
      <div class="desktop ">
        <footer>
          <div class="container-fluid foot pt-5">
            <div class="container ">
              <div class="row row-cols-auto  pt-5">
